package com.eleksploded.woodenfurnace.tile;
...
import com.eleksploded.woodenfurnace.Config;
import com.eleksploded.woodenfurnace.WoodenFurnace;
...
public class TileWoodFurnace extends TileEntityLockable implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickable {
	...
	public void read(NBTTagCompound compound) {
		...
		this.crafts = compound.getInt("Crafts");
	...
	public NBTTagCompound write(NBTTagCompound compound) {
		...
		compound.setInt("Crafts", this.crafts);
	...
	public void tick() {
		if(crafts >= Config.GENERAL.Crafts.get()){
			world.createExplosion(null, WoodenFurnace.damage, pos.getX(), pos.getY(), pos.getZ(), Config.GENERAL.Power.get(), Config.GENERAL.Fire.get(), Config.GENERAL.BlockDamage.get());
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				this.world.setBlockState(this.pos, this.world.getBlockState(this.pos).with(WoodenFurnaceBlock.LIT, Boolean.valueOf(this.isBurning())), 3);
			}
		}
