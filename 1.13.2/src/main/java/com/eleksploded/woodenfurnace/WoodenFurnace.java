...
public class WoodenFurnace
{
    ...
    //Init
    public static final Block woodFurnace = new WoodenFurnaceBlock(Properties.create(Material.WOOD)).setRegistryName(Reference.modid + ":woodfurnace");
    ...
    public static class RegistryEvents {
        ...
        public static void onBlocksRegistry(final RegistryEvent.Register<Block> registry) {
        	LOGGER.info("BlockRegistry");
            registry.getRegistry().register(woodFurnace);
        }
        
        @SubscribeEvent
        public static void item(final RegistryEvent.Register<Item> registry) {
        	
        	
        	ItemBlock itemBlock = new ItemBlock(woodFurnace, new Item.Properties());
        	itemBlock.setRegistryName(woodFurnace.getRegistryName());
